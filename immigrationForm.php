       ...
       <form id="cityzenPth_form" method="POST" >
         ...
         <section id="phase7" class="hidden">
           ...
           <!-- <div>
                 <div class="pro_table">
                   <table>
                     <tr>
                       <td>
                         <label for="name_of_child"
                           >Name of Child:(Last,First,Middle)</label
                         >
                       </td>
                       <td>
                         <label for="child_citizenship"
                           >Child's Citizenship of What Country</label
                         >
                       </td>
                       <td>
                         <label for="child_current_address"
                           >Child's Current Address:(City and Country)</label
                         >
                       </td>
                       <td>
                         <label for="child_immigration_status"
                           >Immigration Status of child</label
                         >
                       </td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                       <td>
                         <label for="child_alien_registration_number"
                           >Child's Alien Registration Number</label
                         >
                       </td>
                       <td>
                         <label for="child_birth_date"
                           >Child's Birth Date:(Month,Day,Year)</label
                         >
                       </td>
                       <td>
                         <label for="child_country_of_birth"
                           >Child's Country of Birth:(City and Country)</label
                         >
                       </td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                       <td colspan="4">
                         <div style="display: flex;">
                           <label for="child_average_earnings" class="text-nowrap"
                             >Child's Average Earnings Per Week: $</label
                           >
                           <input
                             type="text"
                 ...
                 <div class="pro_table">
                   <table>
                     ...
                     <tr>
                       <td>
                         <label for="child_average_earnings"
                           >Child's Average Earnings Per Week: $</label
                         >
           ...
           <div class="pahasebtnBox">
             ...
             <button class="stepBtn" id="pahase7btn" onclick="handlePhase7button()">next &gt;</button>
           </div>
         </section>
         ...
         <section id="phase8" class="hidden">
           ...
           <fieldset id="fildset_about_lived_1" class="hidden">
             ...
             <div class="pro_form_group">
               ...
               <div class="pro_input_Row">
                 <div class="pro_label">
                   <label for="resided_from1">Child's Citizenship of What Country</label>
                 </div>
                 <div class="pro_input">
                   <input
                     type="date"
               ...
               <div class="pro_input_Row">
                 <div class="pro_label">
                   <label for="resided_to1">Child's Current Address:(City and Country)</label>
                 </div>
                 <div class="pro_input">
                   <input
                     type="text"
           ...
           <fieldset id="fildset_about_lived_2" class="hidden">
             ...
             <div class="pro_form_group">
               ...
               <div class="pro_input_Row">
                 <div class="pro_label">
                   <label for="resided_from2">Child's Citizenship of What Country</label>
                 </div>
                 <div class="pro_input">
                   <input
                     type="date"
               ...
               <div class="pro_input_Row">
                 <div class="pro_label">
                   <label for="resided_to2">Child's Current Address:(City and Country)</label>
                 </div>
                 <div class="pro_input">
                   <input
                     type="text"
           ...
           <div class="pahasebtnBox">
             ...
             <button class="stepBtn" id="pahase8btn" onclick="handlePhase8Button()">next &gt;</button>
           </div>
         </section>
         ...
         <section id="phase9" class="hidden">
           ...
           <div class="pahasebtnBox">
             ...
             <button class="stepBtn" id="pahase9btn" onclick="handlePhase9Button()">next &gt;</button>
           </div>
         </section>
         <!-- ======INFORMATION ABOUT YOUR FAMILY :========== -->
         <section id="phase10" class="hidden">
             ...
             <div class="pro_from_group_wraper">
               ...
               <div class="pro_form_group">
                 ...
                 <div class="pro_input_Row">
                   ...
                   <div class="pro_input"><input type="text" id="father_birth_date" name="father_birth_date" required /></div>
                 </div>
                 <!-- --father_birth_date-- -->
                 <div class="pro_input_Row">
               ...
               <div class="pro_form_group">
                 ...
                 <div class="pro_input_Row">
                   <div class="pro_label"><label for="mother_cityzen_of_what_country">Relationship to me</label></div>
                 ...
                 <div class="pro_input_Row">
                   <div class="pro_label"><label for="mother_relationship_to_me">Cityzen of what Country</label></div>
                 ...
                 <div class="pro_input_Row">
                   ...
                   <div class="pro_input"><input type="text" id="mother_birth_date" name="mother_birth_date" required /></div>
                 </div>
               ...
               <div class="pro_form_group">
                 ...
                 <div class="pro_input_Row">
                   ...
                   <div class="pro_input"><input type="text" id="grandfather_birth_date" name="grandfather_birth_date" required /></div>
                 </div>
               ...
               <div class="pro_form_group">
                 ...
                 <div class="pro_input_Row">
                   <div class="pro_label"><label for="grandmother_relationship_to_me">Grandmother Imigration status</label></div>
                 ...
                 <div class="pro_input_Row">
                   ...
                   <div class="pro_input"><input type="text" id="grandmother_birth_date" name="grandmother_birth_date" required /></div>
                 </div>
               ...
               <div class="pro_form_group">
                 ...
                 <div class="pro_input_Row">
                   <div class="pro_label"><label for="grandfather_relationship_to_me_mother_side">Cityzen of what Country</label></div>
                 ...
                 <div class="pro_input_Row">
                   ...
                   <div class="pro_input"><input type="text" id="grandfather_birth_date_mother_side" name="grandfather_birth_date_mother_side" required /></div>
                 </div>
               ...
               <div class="pro_form_group">
                 ...
                 <div class="pro_input_Row">
                   <div class="pro_label"><label for="grandmother_relationship_to_me_mother_side">Cityzen of what Country</label></div>
                 ...
                 <div class="pro_input_Row">
                   ...
                   <div class="pro_input"><input type="text" id="grandmother_birth_date_mother_side" name="grandmother_birth_date_mother_side" required /></div>
                 </div>
               ...
               <div class="pro_form_group">
                 ...
                 <div class="pro_input_Row">
                   <div class="pro_label"><label for="brother_relationship_to_me">Cityzen of what Country</label></div>
                 ...
                 <!-- --brother_birth_date-- -->
                 <div class="pro_input_Row">
                   <div class="pro_label"><label for="brother_birth_date">Grandmother's Birth Date:(Month,Day,Year)</label></div>
                   <div class="pro_input"><input type="text" id="brother_birth_date" name="brother_birth_date" required /></div>
                 </div>
           ...
           <div class="pahasebtnBox">
             ...
             <button type="submit" name="submit" class="submitBtn" onclick="handleSubmit()">Submit</button>
           </div>
